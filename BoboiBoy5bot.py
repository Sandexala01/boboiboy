...
cl = LINETCR.LINE() #SANDEXALA《1》
cl.login(qr=True)
cl.loginResult()

ki = LINETCR.LINE() #SANDEXALA《2》
ki.login(qr=True)
ki.loginResult()

kk = LINETCR.LINE() #SANDEXALA《3》
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() #SANDEXALA《4》
kc.login(qr=True)
kc.loginResult()

ks = LINETCR.LINE() #SANDEXALA《5》
ks.login(qr=True)
ks.loginResult()

print "login success ₳$₮ɌØɃØ¥ "
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""A҉ s҉ t҉ r҉ o҉ b҉ o҉ y҉  t҉ e҉ a҉ m҉  b҉ o҉ t҉  p҉ r҉ o҉ t҉ e҉ c҉ t҉ 
Owner : ✰AstroBoy✰
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
...
👑Hanya Untuk Owner👑
-==================-
A҉ s҉ t҉ r҉ o҉ b҉ o҉ y҉  t҉ e҉ a҉ m҉  b҉ o҉ t҉  p҉ r҉ o҉ t҉ e҉ c҉ t҉ 
-==================-
"""
KAC=[cl,ki,kk,kc,ks]
