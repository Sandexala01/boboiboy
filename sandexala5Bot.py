...
cl = LINETCR.LINE() #$₳₦ƉɆӾ₳Ⱡ₳1
cl.login(qr=True)
cl.loginResult()

ki = LINETCR.LINE() #$₳₦ƉɆӾ₳Ⱡ₳2
ki.login(qr=True)
ki.loginResult()

kk = LINETCR.LINE() #$₳₦ƉɆӾ₳Ⱡ₳3
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() #$₳₦ƉɆӾ₳Ⱡ₳4
kc.login(qr=True)
kc.loginResult()

ks = LINETCR.LINE() #$₳₦ƉɆӾ₳Ⱡ₳5
ks.login(qr=True)
ks.loginResult()
...
helpMessage ="""s҉ a҉ n҉ d҉ e҉ x҉ a҉ l҉ a҉  t҉ e҉ a҉ m҉  b҉ o҉ t҉  p҉ r҉ o҉ t҉ e҉ c҉ t҉ 
Owner : ☆̶ s̶̶a̶̶n̶̶d̶̶e̶̶x̶̶a̶̶l̶̶a̶✰
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
[•]Ownerlist
...
mid = cl.getProfile().mid #$₳₦ƉɆӾ₳Ⱡ₳1
Amid = ki.getProfile().mid #$₳₦ƉɆӾ₳Ⱡ₳2
Bmid = kk.getProfile().mid #$₳₦ƉɆӾ₳Ⱡ₳3
Cmid = kc.getProfile().mid #$₳₦ƉɆӾ₳Ⱡ₳4
Dmid = ks.getProfile().mid #$₳₦ƉɆӾ₳Ⱡ₳5
...
☆ Destroyers ☆
Minat? Silahkan PM!
Idline: http://line.me/ti/p/XUFPKBX6iQ""",
    "lang":"JP",
